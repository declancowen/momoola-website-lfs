...
const Feature = React.memo(function Feature({
	...
	return (
		<div
			className={cn(
				"flex flex-col py-6 md:py-8 relative group/feature transform-gpu",
				"border-b md:border-r border-neutral-200",
		...
		>
			...
			<div className="mb-4 relative z-10 px-6 text-black">
				{icon}
			</div>
			...
			<p className="text-sm text-neutral-700 max-w-xs relative z-10 px-6">
...
export default function Benefits() {
	...
	return (
		<section id="benefits" className="w-full bg-gray-50 min-h-[100dvh] flex items-center relative z-10 py-16 pb-24 md:py-24">

			<div className="absolute -bottom-8 lg:bottom-20 inset-x-0 z-20">
			...
			<div className="container mx-auto px-6 sm:px-6 flex items-center">
				<div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 w-full">
					<div className="w-full lg:w-1/2 h-[700px] lg:h-[700px] relative flex items-center overflow-hidden">
						<div className="absolute inset-0 flex items-center justify-center h-full bg-transparent">
							<div className="relative w-[90%] lg:w-[95%] h-full mx-auto flex items-center">
								<AnimatePresence mode="wait" custom={direction}>
									<motion.div
										...
										animate="enter"
										exit="exit"
										className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 w-full border border-neutral-200 rounded-lg overflow-hidden transform-gpu will-change-transform bg-white shadow-sm"
									>
					...
					<div className="w-full lg:w-1/2 flex flex-col justify-center px-4 md:px-0 text-center lg:text-left">
						...
						<motion.p
							...
							className="text-lg md:text-xl text-black leading-relaxed md:leading-loose lg:pr-7 mb-8 md:mb-12 transform-gpu"
						>
							{activeIndex === 0 ? (
